...
def _impl(ctx):
    ...
    default_compile_flags_feature = feature(
        ...
        flag_sets = [
            ...
            flag_set(
                ...
                flag_groups = [flag_group(flags = ["-g0", "-O0"])],
            ...
            flag_set(
                ...
                flag_groups = [flag_group(flags = ["-g0", "-Oz", "-DNDEBUG"])],
    ...
    default_link_flags_feature = feature(
        ...
        flag_sets = [
            ...
            flag_set(
                actions = all_link_actions,
                flag_groups = [flag_group(flags = ["-g0", "-Oz", "--closure", "1"])],
                with_features = [with_feature_set(features = ["opt"])],
            ),
        ],
    )
...
cc_toolchain_config = rule(
    ...
    attrs = {
        "cpu": attr.string(mandatory = True, values = ["emscripten"]),
    },
